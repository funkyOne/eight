...
const SettingsCog = ({ onClick }: { onClick: (e: MouseEvent) => void }) => (
  <button className="settings-cog" onClick={onClick} aria-label="Settings">
    ...
    <div className="app">
      {showSettings ? (
        ...
        <div className="start-screen" onClick={handleStart}>
          <SettingsCog onClick={handleSettingsClick} />
